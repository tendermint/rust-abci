    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeEnum<CodeType>>(
                    "code",
                    |m: &ResponseCommit| { &m.code },
                    |m: &mut ResponseCommit| { &mut m.code },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "data",
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "log",
                    |m: &ResponseCommit| { &m.log },
                    |m: &mut ResponseCommit| { &mut m.log },
                ));
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<Validator>>(
                    "diffs",
                    |m: &ResponseEndBlock| { &m.diffs },
                    |m: &mut ResponseEndBlock| { &mut m.diffs },
                ));
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "pubKey",
                    |m: &Validator| { &m.pubKey },
                    |m: &mut Validator| { &mut m.pubKey },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                    "power",
                    |m: &Validator| { &m.power },
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0fsrc/types.proto\x12\x05types\"\x90\x04\n\x07Request\x12&\n\x04echo\
    \x18\x01\x20\x01(\x0b2\x12.types.RequestEchoH\0B\x02\x18\0\x12(\n\x05flu\
    sh\x18\x02\x20\x01(\x0b2\x13.types.RequestFlushH\0B\x02\x18\0\x12&\n\x04\
    info\x18\x03\x20\x01(\x0b2\x12.types.RequestInfoH\0B\x02\x18\0\x121\n\ns\
    et_option\x18\x04\x20\x01(\x0b2\x17.types.RequestSetOptionH\0B\x02\x18\0\
    \x121\n\ndeliver_tx\x18\x05\x20\x01(\x0b2\x17.types.RequestDeliverTxH\0B\
    \x02\x18\0\x12-\n\x08check_tx\x18\x06\x20\x01(\x0b2\x15.types.RequestChe\
    ckTxH\0B\x02\x18\0\x12*\n\x06commit\x18\x07\x20\x01(\x0b2\x14.types.Requ\
    estCommitH\0B\x02\x18\0\x12(\n\x05query\x18\x08\x20\x01(\x0b2\x13.types.\
    RequestQueryH\0B\x02\x18\0\x121\n\ninit_chain\x18\t\x20\x01(\x0b2\x17.ty\
    pes.RequestInitChainH\0B\x02\x18\0\x123\n\x0bbegin_block\x18\n\x20\x01(\
    \x0b2\x18.types.RequestBeginBlockH\0B\x02\x18\0\x12/\n\tend_block\x18\
    \x0b\x20\x01(\x0b2\x16.types.RequestEndBlockH\0B\x02\x18\0B\x07\n\x05val\
    ue\"\"\n\x0bRequestEcho\x12\x13\n\x07message\x18\x01\x20\x01(\tB\x02\x18\
    \0\"\x0e\n\x0cRequestFlush\"\r\n\x0bRequestInfo\"6\n\x10RequestSetOption\
    \x12\x0f\n\x03key\x18\x01\x20\x01(\tB\x02\x18\0\x12\x11\n\x05value\x18\
    \x02\x20\x01(\tB\x02\x18\0\"\"\n\x10RequestDeliverTx\x12\x0e\n\x02tx\x18\
    \x01\x20\x01(\x0cB\x02\x18\0\"\x20\n\x0eRequestCheckTx\x12\x0e\n\x02tx\
    \x18\x01\x20\x01(\x0cB\x02\x18\0\"Y\n\x0cRequestQuery\x12\x10\n\x04data\
    \x18\x01\x20\x01(\x0cB\x02\x18\0\x12\x10\n\x04path\x18\x02\x20\x01(\tB\
    \x02\x18\0\x12\x12\n\x06height\x18\x03\x20\x01(\x04B\x02\x18\0\x12\x11\n\
    \x05prove\x18\x04\x20\x01(\x08B\x02\x18\0\"\x0f\n\rRequestCommit\"<\n\
    \x10RequestInitChain\x12(\n\nvalidators\x18\x01\x20\x03(\x0b2\x10.types.\
    ValidatorB\x02\x18\0\"H\n\x11RequestBeginBlock\x12\x10\n\x04hash\x18\x01\
    \x20\x01(\x0cB\x02\x18\0\x12!\n\x06header\x18\x02\x20\x01(\x0b2\r.types.\
    HeaderB\x02\x18\0\"%\n\x0fRequestEndBlock\x12\x12\n\x06height\x18\x01\
    \x20\x01(\x04B\x02\x18\0\"\xcf\x04\n\x08Response\x121\n\texception\x18\
    ...
    \0B\x02\x18\0\x122\n\ndeliver_tx\x18\x06\x20\x01(\x0b2\x18.types.Respons\
    eDeliverTxH\0B\x02\x18\0\x12.\n\x08check_tx\x18\x07\x20\x01(\x0b2\x16.ty\
    pes.ResponseCheckTxH\0B\x02\x18\0\x12+\n\x06commit\x18\x08\x20\x01(\x0b2\
    \x15.types.ResponseCommitH\0B\x02\x18\0\x12)\n\x05query\x18\t\x20\x01(\
    \x0b2\x14.types.ResponseQueryH\0B\x02\x18\0\x122\n\ninit_chain\x18\n\x20\
    \x01(\x0b2\x18.types.ResponseInitChainH\0B\x02\x18\0\x124\n\x0bbegin_blo\
    ck\x18\x0b\x20\x01(\x0b2\x19.types.ResponseBeginBlockH\0B\x02\x18\0\x120\
    \n\tend_block\x18\x0c\x20\x01(\x0b2\x17.types.ResponseEndBlockH\0B\x02\
    ...
    \x20\x01(\x04B\x02\x18\0\x12\x1f\n\x13last_block_app_hash\x18\x04\x20\
    \x01(\x0cB\x02\x18\0\"$\n\x11ResponseSetOption\x12\x0f\n\x03log\x18\x01\
    \x20\x01(\tB\x02\x18\0\"Y\n\x11ResponseDeliverTx\x12!\n\x04code\x18\x01\
    \x20\x01(\x0e2\x0f.types.CodeTypeB\x02\x18\0\x12\x10\n\x04data\x18\x02\
    \x20\x01(\x0cB\x02\x18\0\x12\x0f\n\x03log\x18\x03\x20\x01(\tB\x02\x18\0\
    \"W\n\x0fResponseCheckTx\x12!\n\x04code\x18\x01\x20\x01(\x0e2\x0f.types.\
    CodeTypeB\x02\x18\0\x12\x10\n\x04data\x18\x02\x20\x01(\x0cB\x02\x18\0\
    \x12\x0f\n\x03log\x18\x03\x20\x01(\tB\x02\x18\0\"\xa1\x01\n\rResponseQue\
    ry\x12!\n\x04code\x18\x01\x20\x01(\x0e2\x0f.types.CodeTypeB\x02\x18\0\
    \x12\x11\n\x05index\x18\x02\x20\x01(\x03B\x02\x18\0\x12\x0f\n\x03key\x18\
    \x03\x20\x01(\x0cB\x02\x18\0\x12\x11\n\x05value\x18\x04\x20\x01(\x0cB\
    \x02\x18\0\x12\x11\n\x05proof\x18\x05\x20\x01(\x0cB\x02\x18\0\x12\x12\n\
    \x06height\x18\x06\x20\x01(\x04B\x02\x18\0\x12\x0f\n\x03log\x18\x07\x20\
    \x01(\tB\x02\x18\0\"V\n\x0eResponseCommit\x12!\n\x04code\x18\x01\x20\x01\
    (\x0e2\x0f.types.CodeTypeB\x02\x18\0\x12\x10\n\x04data\x18\x02\x20\x01(\
    \x0cB\x02\x18\0\x12\x0f\n\x03log\x18\x03\x20\x01(\tB\x02\x18\0\"\x13\n\
    \x11ResponseInitChain\"\x14\n\x12ResponseBeginBlock\"7\n\x10ResponseEndB\
    lock\x12#\n\x05diffs\x18\x01\x20\x03(\x0b2\x10.types.ValidatorB\x02\x18\
    \0\"\xec\x01\n\x06Header\x12\x14\n\x08chain_id\x18\x01\x20\x01(\tB\x02\
    \x18\0\x12\x12\n\x06height\x18\x02\x20\x01(\x04B\x02\x18\0\x12\x10\n\x04\
    time\x18\x03\x20\x01(\x04B\x02\x18\0\x12\x13\n\x07num_txs\x18\x04\x20\
    \x01(\x04B\x02\x18\0\x12)\n\rlast_block_id\x18\x05\x20\x01(\x0b2\x0e.typ\
    es.BlockIDB\x02\x18\0\x12\x1c\n\x10last_commit_hash\x18\x06\x20\x01(\x0c\
    B\x02\x18\0\x12\x15\n\tdata_hash\x18\x07\x20\x01(\x0cB\x02\x18\0\x12\x1b\
    \n\x0fvalidators_hash\x18\x08\x20\x01(\x0cB\x02\x18\0\x12\x14\n\x08app_h\
    ash\x18\t\x20\x01(\x0cB\x02\x18\0\"D\n\x07BlockID\x12\x10\n\x04hash\x18\
    \x01\x20\x01(\x0cB\x02\x18\0\x12'\n\x05parts\x18\x02\x20\x01(\x0b2\x14.t\
    ypes.PartSetHeaderB\x02\x18\0\"4\n\rPartSetHeader\x12\x11\n\x05total\x18\
    \x01\x20\x01(\x04B\x02\x18\0\x12\x10\n\x04hash\x18\x02\x20\x01(\x0cB\x02\
    \x18\0\"2\n\tValidator\x12\x12\n\x06pubKey\x18\x01\x20\x01(\x0cB\x02\x18\
    \0\x12\x11\n\x05power\x18\x02\x20\x01(\x04B\x02\x18\0*\xb9\x05\n\x08Code\
    Type\x12\x06\n\x02OK\x10\0\x12\x11\n\rInternalError\x10\x01\x12\x11\n\rE\
    ncodingError\x10\x02\x12\x0c\n\x08BadNonce\x10\x03\x12\x10\n\x0cUnauthor\
    ized\x10\x04\x12\x15\n\x11InsufficientFunds\x10\x05\x12\x12\n\x0eUnknown\
    Request\x10\x06\x12\x18\n\x14BaseDuplicateAddress\x10e\x12\x15\n\x11Base\
    EncodingError\x10f\x12\x18\n\x14BaseInsufficientFees\x10g\x12\x19\n\x15B\
    aseInsufficientFunds\x10h\x12\x1c\n\x18BaseInsufficientGasPrice\x10i\x12\
    \x14\n\x10BaseInvalidInput\x10j\x12\x15\n\x11BaseInvalidOutput\x10k\x12\
    \x15\n\x11BaseInvalidPubKey\x10l\x12\x17\n\x13BaseInvalidSequence\x10m\
    \x12\x18\n\x14BaseInvalidSignature\x10n\x12\x16\n\x12BaseUnknownAddress\
    \x10o\x12\x15\n\x11BaseUnknownPubKey\x10p\x12\x15\n\x11BaseUnknownPlugin\
    \x10q\x12\x15\n\x10GovUnknownEntity\x10\xc9\x01\x12\x14\n\x0fGovUnknownG\
    roup\x10\xca\x01\x12\x17\n\x12GovUnknownProposal\x10\xcb\x01\x12\x16\n\
    \x11GovDuplicateGroup\x10\xcc\x01\x12\x17\n\x12GovDuplicateMember\x10\
    \xcd\x01\x12\x19\n\x14GovDuplicateProposal\x10\xce\x01\x12\x15\n\x10GovD\
    uplicateVote\x10\xcf\x01\x12\x15\n\x10GovInvalidMember\x10\xd0\x01\x12\
    \x13\n\x0eGovInvalidVote\x10\xd1\x01\x12\x1a\n\x15GovInvalidVotingPower\
    \x10\xd2\x01\x1a\x02\x10\0B\0b\x06proto3\
";
